...
class RAGFlowPdfParser:
    def __init__(self, **kwargs):
        ...
        self._updown_model_ready = False
        try:
            pip_install_torch()
            import torch.cuda
        ...
        try:
            ...
            try:
                ...
                logging.warning("updown_concat_xgb.model unavailable; continuing without it.")
